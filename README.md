...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 Semantic HTML gives meaning to a webpage rather than just presentation.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display block is when the element is displayed as a block.

display: inline is when the element is displayed inline on the same block.

3. What are the 4 areas of the box model?
padding edge, content edge, and border and margin edge

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
alignment of all items on cross axis

5. Explain why git is valuable to a team of developers.
Git gives us performance, functionality, flexibility, and it's more secure.
